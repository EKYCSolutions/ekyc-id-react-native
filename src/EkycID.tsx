...
class EkycIDWrapper {
  startDocumentScanner = async (
    scannerOptions: DocumentScannerScannerOptions,
    overlayOptions: DocumentScannerOverlayOptions
  ): Promise<DocumentScannerResponse> => {
    console.log('TODO: overlay options', overlayOptions);
  ...
  startLivenessDetection = async (
    scannerOptions?: LivenessDetectionScannerOptions,
    overlayOptions?: LivenessDetectionOverlayOptions
  ): Promise<LivenessDetectionResponse> => {
    const nativeResponse = await EkycIDNative.startLivenessDetection(
      scannerOptions,
      overlayOptions
    );
